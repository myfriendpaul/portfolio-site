      ...
      <div className="w-full max-w-sm mx-auto  border border-gray-100 rounded-md ">
        ...
        {!isSubmitSuccessful && (
          <form onSubmit={handleSubmit(onSubmit)} class="mt-48">
            {" "}
            <h1 class="text-center mb-4 text-4xl text-gray-600">
              Lets work together!
            </h1>
            <input
              type="hidden"
              value="cbff6e40-934f-400e-b04a-2d2f088ec6df"
              {...register("apikey")}
            />{" "}
            <input
              type="hidden"
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2  rounded-md outline-none  focus:ring-4  ${
                  errors.name
                    ...
                    : "border-gray-300 focus:border-gray-600 ring-indigo-100"
                }`}
                {...register("name", {
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                className={`w-full px-4 py-3 border-2  rounded-md outline-none  h-36  focus:ring-4  ${
                  errors.message
                    ? "border-red-600 focus:border-red-600 ring-red-100"
                    : "border-gray-300 focus:gray-indigo-600 ring-indigo-100"
                }`}
            ...
            <button
              type="submit"
              className="w-full py-4 text-white transition-colors bg-gray-600 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-indigo-200 px-7 umami--click--contact-submit"
            >
              {" "}
              {isSubmitting ? (
                <svg
          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center text-center text-white rounded-md">
              ...
              <svg
                width="100"
                height="100"
                className="text-green-300 mt-48"
                viewBox="0 0 100 100"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
